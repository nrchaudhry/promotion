...
public interface promotionRepository extends JpaRepository<Promotion, Long> {
	...
	@Query(value = "SELECT * FROM TBLPROMOTION "
	        + "where (PROMOTIONTYPE_ID = CASE WHEN :PRMOTIONTYPE_ID = 0 THEN PROMOTIONTYPE_ID ELSE :PRMOTIONTYPE_ID END OR PROMOTIONTYPE_ID IS NULL) "
	        + "and (CASE WHEN :DISCOUNTYPE_ID = 0 THEN DISCOUNTYPE_ID=DISCOUNTYPE_ID ELSE DISCOUNTYPE_ID IN (:DISCOUNTYPE_IDS) END or DISCOUNTYPE_ID is NULL) "
	...
	List<Promotion> findByAdvancedSearch(
	        @Param("PRMOTIONTYPE_ID") Long PRMOTIONTYPE_ID,
	        @Param("DISCOUNTYPE_ID") Long DISCOUNTYPE_ID, @Param("DISCOUNTYPE_IDS") List<Integer> DISCOUNTYPE_IDS,
